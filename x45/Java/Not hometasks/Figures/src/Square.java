...
public class Square extends Rectangle{
    ...
    public double Area(){
        return p1.distX(p2) * p1.distX(p2);
    }

    public double Perimeter(){
        return 2 * p1.distX(p2);
    }
    ...
    // otnoshenie radiusov vpisannoy i opisannoy okruzhnostey...
    public double TipaUmniyMetod(){
        return (p1.distX(p2) / 2) /
                (p1.dist(p2) / 2);
    }
}
