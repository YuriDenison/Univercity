...
import filesystem.btreefilesystem.BTreeFileSystem;
...
/**
 * Test class for BTreeFileSystem
 *
 * @author Yuri Denison
 */
public class BTreeFileSystemTest {
    private BTreeFileSystem fs;
    private BTreeFileSystemManager fileSystemManager;
    private static final int ITERATIONS = 800;

    @Before
    public void setUp() throws Exception {
        PropertyConfigurator.configure("res/log4j.properties");
        fileSystemManager = new BTreeFileSystemManager();
    }
    ...
    public void testOpenFileSystem() throws Exception {
        ...
        BTreeFileSystem fs1 = fileSystemManager.openFileSystem("test.fs");
